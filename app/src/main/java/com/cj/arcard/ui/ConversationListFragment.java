    ...
    protected void setUpView() {
        ...
        conversationListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                bmobQuery.addWhereEqualTo("username",from);
                bmobQuery.findObjects(new FindListener<MyUser>() {
                    @Override
                    public void done(List<MyUser> list, BmobException e) {
                        String otherAvatorUrl = list.get(0).getAvatorUrl();
                        LogUtil.d("otherAvatorUrl"+otherAvatorUrl);
                        com.cj.arcard.utils.PreferenceManager.getInstance().setOtherUserAvatorUrl(otherAvatorUrl);
