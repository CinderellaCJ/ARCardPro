...
public class PreferenceManager {
	...
	private static String BMOB_CURRENTUSER_AVAOTR = "BMOB_CURRENTUSER_AVAOTR";
	private static String BMOB_ORTHER_AVAOTR = "BMOB_ORTHER_AVAOTR";
	...
	public void setCurrentUserAvatorUrl(String avatorUrl){
		editor.putString(BMOB_CURRENTUSER_AVAOTR,avatorUrl);
		editor.apply();
	}

	public void setOtherUserAvatorUrl(String avatorUrl){
		editor.putString(BMOB_ORTHER_AVAOTR,avatorUrl);
		editor.apply();
	}
	...
	public String getCurrentUserAvatorUrl(){
		return mSharedPreferences.getString(BMOB_CURRENTUSER_AVAOTR, null);
	}

	public String getOtherUserAvatorUrl(){
		return mSharedPreferences.getString(BMOB_ORTHER_AVAOTR, null);
	}
