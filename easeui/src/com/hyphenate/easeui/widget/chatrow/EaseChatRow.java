...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
           ...
           // Glide.with(getContext()).load().into(userAvatarView);
        }else{
           // EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
           // Log.d("aaa",message.getFrom());
//            String otherAvatorUrl = PreferenceManager.getInstance().getOtherUserAvatorUrl();

            //EaseUser easeUser = EaseUserUtils.getUserInfo(m/essage.getFrom());
           // Glide.with(getContext()).load(easeUser.getAvatar()).into(userAvatarView);
            EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
